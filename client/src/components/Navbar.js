...
const Navbar = () => {
    return (
        <>
            {/* Move svg icons to separate files */}
            <nav className="navbar navbar-expand-lg bg-body-tertiary">
                <NavLink key="account" to="/">
                    <svg
                        ...
                        className="nav-icon"
                        activeClassName="bav-icon-active"
                    >
                        <rect
                            x="1"
                            y="4"
                    ...
                    <div className="label">Картка</div>
                </NavLink>
                <NavLink key="account" to="/">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="label">Кредити</div>
                </NavLink>
                <NavLink key="account" to="/savings">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        className="nav-icon saving-icon"
                    >
                    ...
                    <div className="label">Накопичення</div>
                </NavLink>
                <NavLink key="account" to="/">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
