...
const Navigation = () => {
    // TODO: Use hoc component to separate auth check from routing
    // TODO: Wrap with login check account dependent routes
        ...
        <Router>
            <Routes>
                <Route path="/" element={<App />}>
                    ...
                    />
                    <Route
                        path="/cards-and-accounts"
                        element={<CardsAndAccounts />}
                    />
