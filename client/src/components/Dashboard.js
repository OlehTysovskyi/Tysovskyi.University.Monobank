...
const Dashboard = () => {
    ...
    // TODO: Create utility function for parsing data from given variables (storage)
    ...
    return (
        <div className="dashboard">
            ...
            <button type="button" className="logout-btn" onClick={handleLogout}>
                {/* TODO: Replace with obj?.property notation */}
            ...
            <div className="menu">
                <div className="btn-container">
                    ...
                    {/* TODO: Replace plain text with paragraphs for support of assistive technologies */}
